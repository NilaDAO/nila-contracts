...
/**
 npx hardhat run scripts/handleSharedCropping/upgradeBase.js --network amoy
 */


/**
🟢  SharedCroppingUpgradeable deployed!
...
async function main() {
  ...
  const FoodV2 = await ethers.getContractFactory("SharedCroppingUpgradeable"); // or your new version
  ...
  const food = await ethers.getContractAt("SharedCroppingUpgradeable", FOOD_PROXY);
